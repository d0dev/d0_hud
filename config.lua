...
showers = { -- shower station
    ...
    {pos = vector3(347.2184, -995.199, -99.11185), particle = "ent_amb_car_wash_jet", xRot = -180.0, nextWait = 0, h=257.05},
    {pos = vector3(961.9681, -666.2462, 1142.637), particle = "ent_amb_car_wash_jet", xRot = -180.0, nextWait = 0, h=257.05},
